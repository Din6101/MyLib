defmodule MyLibWeb.BookLiveTest do
  use MyLibWeb.ConnCase

  import Phoenix.LiveViewTest
  import MyLib.AccountsFixtures

  @create_attrs %{title: "some title", author: "some author", isbn: "some isbn", published_at: "2025-07-15"}
  @update_attrs %{title: "some updated title", author: "some updated author", isbn: "some updated isbn", published_at: "2025-07-16"}
